...
if(isset($_POST['am']) && isset($_POST['loc']))
{
    if(!empty($_POST['am']) && !empty($_POST['loc']))
    {   
        $trans=new Transactions ($_POST['am'],'Withdraw',$_POST['loc']);
        $am=new DBTransaction;
       
        //$country=file_get_contents('http://api.hostip.info/get_html.php?ip=');
        if($am->withdraw($trans)){
            $alert ="true";
        }
        else{
            if($_SESSION["errMsg"]==""){
                header("location: securityWithdraw.php");
            }
            else{
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="index.php">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="Deposit.php"><i class="fas fa-money-bill-wave"></i><span>Deposit</span></a><a class="nav-link active" href="Withdraw.php"><i class="fas fa-money-bill-wave"></i><span>Withdraw</span></a><a class="nav-link" href="help.php"><i class="fas fa-hands-helping"></i><span>Help</span></a></li>
            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <p style="color: rgb(0,0,0);font-size: 25px;margin-top: 16px;">Withdraw</p>
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 fw-bold" style="font-size: 25px;">Withdraw</p>
                                        </div>
                                        <div class="card-body">
                                            <form method="post" class="withdraw-form" name = "form1" onsubmit="required()">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Amount</strong></label><input class="form-control" type="number" id="username" placeholder="100..200.." name="am"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="email"><strong>Location</strong><br></label><input class="form-control" type="text" id="email" placeholder="ex-Cairo" name="loc"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
