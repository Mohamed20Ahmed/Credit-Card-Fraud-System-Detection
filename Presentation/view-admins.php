...
<body id="page-top">
    ...
    <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="view-users.php">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link" href="view-users.php"><i class="fas fa-user"></i><span>View Users</span></a><a class="nav-link active" href="view-admins.php"><i class="fas fa-user-shield"></i><span>View Admins</span></a><a class="nav-link " href="edit-admins.php"><i class="far fa-edit"></i>Delete Admins<span></span></a><a class="nav-link" href="add-admins.php"><i class="far fa-address-book"></i>Add Admins<span></span></a></li>
            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop-1" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <p style="color: rgb(0,0,0);font-size: 25px;margin-top: 16px;">View Admins&nbsp;</p>
                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold" style="font-size: 25px;color: rgb(0,0,0);">Admins</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    <thead>
                                        <tr>
                                            <th><br><strong>AdminID</strong><br></th>
                                            <th><br><strong>Firstname</strong><br></th>
                                            <th><br><br><br><strong>Lastname</strong><br></th>
                                            <th><br><br><strong>Login_id</strong><br></th>
                                            <th><br><br><strong>Super_Aid</strong><br></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php 
                                ...
                                <tr>
                                    <th><?php echo $admin["AdminID"]?></th>
                                    <th><?php echo $admin["Firstname"]?></th>
                                    <th><?php echo $admin["Lastname"]?></th>
                                    <th><?php echo $admin["Login_id"]?></th>
                                    <th><?php echo $admin["Super_Aid"]?></th>
                                </tr>
                                </thead>
